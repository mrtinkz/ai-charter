    ...
    <div className="flex flex-col gap-10">
      <section>
        ...
        <p className="mt-4 text-lg text-black/70 max-w-2xl">
          ...
          wrong. Global guidance, not a national policy.
        </p>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-blue-50 rounded-lg p-5">
          ...
          <p className="mt-2 text-sm text-black/70 m-0">
            Threats are managed by requiring models to disclose what they do and why, not by slowing development
            down with costly review cycles.
          </p>
        </div>
        <div className="bg-blue-50 rounded-lg p-5">
          <h2 className="text-lg font-semibold m-0">Certification as a contract</h2>
          <p className="mt-2 text-sm text-black/70 m-0">
            A model's certification names it, its version, its status, and any unintended consequences on record,
            like a HAZMAT placard for software.
          </p>
        </div>
        <div className="bg-blue-50 rounded-lg p-5">
